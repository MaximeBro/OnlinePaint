...
public class DataRecepteur extends Thread {
    ...
    public DataRecepteur(DataStorage dataStorage, InetAddress ip, int port, String nom) throws IOException {
    ...
    public void run() {
        ...
        while(true) {
            ...
            try {
                ...
                if(texte.contains("name")) {
                    String[] tab = texte.split(",");
                    this.dataStorage.checkClient(tab[1], tab[2]);
                }

                if(texte.contains("data,") && texte.contains("add")) {
                    this.dataStorage.ajouterData(texte.substring(5));
                }

                if(texte.contains("data,") && texte.contains("remove")) {
                    this.dataStorage.supprimerData(texte.substring(5));
                }
